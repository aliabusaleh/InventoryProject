...
public class SellStatsController implements Initializable,Init {
    ...
    private void getData(String name, String start, String end, String sortingType){
        ...
        try {
            ...
            priceSumLabel.setText(stats1.getString("SUM(sell.sell_price)") != null?  stats1.getString("SUM(sell.sell_price)") + " شيكل" : "0 شيكل");
            ...
            averagePriceLabel.setText(stats2.getString("asd") != null?  stats2.getString("asd") + " شيكل" : "0 شيكل");
