...
import static Include.Common.getAllCustomers;

import static Include.Common.getConnection;
import static Include.Common.getPrice;
import static Include.Common.getProductByName;
import static Include.Common.getCustomerByName;
...
public class NewSellController implements Initializable,Init,CommonMethods {
    ...
    @FXML private ChoiceBox nameBox,nameBox_customer;
    ...
    private final ObservableList<String> CustomernameList = getAllCustomers(0);
    ...
    (final TableColumn<Sell, String> param) -> {
        ...
        nameBox_customer.setItems(CustomernameList);
